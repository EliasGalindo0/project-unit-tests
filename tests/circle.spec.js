...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect.objectContaining({radius: expect.any(Number), area: expect.any(Number), circumference: expect.any(Number)});
    ...
    expect.objectContaining({radius: expect(3), area: expect(28.25), circumference: expect(18.84)});(3, 28.25, 18.84);
  });
});
