...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const objetoRetornado = createMenu({food: {'coxinha': 3.9, 'sanduiche': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}});
    ...
    // ```
    expect(objetoRetornado.fetchMenu()).toEqual({food: {'coxinha': 3.9, 'sanduiche': 9.9}, drink: {'agua': 3.9, 'cerveja': 6.9}});
    ...
    // ```
    if (objetoRetornado.order('coxinha', 'agua', 'sanduiche', 'sashimi')) expect(objetoRetornado.consumption).toEqual(['coxinha', 'agua', 'sanduiche', 'sashimi']);
    ...
    // ```
    if (objetoRetornado.order('coxinha', 'agua', 'coxinha')) expect(objetoRetornado.consumption).toEqual(['coxinha', 'agua', 'coxinha']);
